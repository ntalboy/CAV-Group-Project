openProject("TrafficLightNegotiation");%% Traffic Light Negotiation
...
%
% You can apply the modeling patterns used in this examopenProject("TrafficLightNegotiation");ple to test your own
...
% |scenario_TLN_left_turn_with_cross_over_vehicle|, that contains an ego
...
% |scenario_TLN_left_turn_with_lead_vehicle| scenario.
...
%
% Configure the |TrafficLightNegotiationTestBench| model to use the
% |scenario_TLN_left_turn_with_cross_over_vehicle| scenario.
...
% |scenario_TLN_left_turn_with_cross_over_vehicle| scenarios. Below is a
